      ...
      <div className="container mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex gap-4 mt-2">
              <a href="#" className="w-10 h-10 rounded-full bg-ibg-navy-light flex items-center justify-center text-ibg-copper hover:bg-ibg-copper hover:text-white transition-all duration-300 active:scale-95 active:opacity-70">
            ...
            <ul className="flex flex-col gap-4 mt-2">
              {quickLinks.map((item, index) => (
                <li key={index}>
                  <Link
                    href={item.path}
                    className="text-ibg-gray hover:text-ibg-copper-light active:opacity-70 transition-all duration-150 relative group inline-block"
                  >
                    {item.name}
        ...
        <div className="pt-8 border-t border-ibg-navy-light flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6 text-sm text-ibg-gray">
            ...
            <Link href="/privacy" className="hover:text-ibg-copper active:opacity-70 transition-all duration-150">Privacy Policy</Link>
          </div>
        </div>
      </div>
    </footer>
