        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {featured.map((project, index) => (
            <ScrollReveal key={project.id} delay={index * 0.2}>
              <div className="group bg-white rounded shadow-sm border border-ibg-copper/10 overflow-hidden hover:shadow-xl transition-all duration-500 h-full flex flex-col hover:-translate-y-2">
